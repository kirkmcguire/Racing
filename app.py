...
def summarize_events(
    ...
    # Defensive: some exports / edge cases can lack lap_number after cleaning
    has_lap = "lap_number" in d.columns
    if has_lap:
    ...
    for issue_id, evs in by_id.items():
        ...
        for e in evs:
            lap_key = round(e.lap, 0) if not np.isnan(e.lap) else 0.0
            key = (lap_key, _corner_bin(e.distance_m, 50))
